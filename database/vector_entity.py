...
class VectorEntity1024:
    ...
    embedding = Float32Vector(id=4, uid=369938825836818176, index=HnswIndex(dimensions=1024, distance_type=VectorDistanceType.COSINE))
...
class VectorEntity128:
    ...
    content = String(id=3, uid=1078614701445763727, index=Index(type=IndexType.VALUE, uid=1703725148714040606))
    embedding = Float32Vector(id=4, uid=7560827336622966584, index=HnswIndex(dimensions=128, distance_type=VectorDistanceType.COSINE))
...
class VectorEntity1536:
    ...
    content = String(id=3, uid=4233813361513752915, index=Index(type=IndexType.VALUE, uid=4136246846239337743))
    embedding = Float32Vector(id=4, uid=6332384653779176856, index=HnswIndex(dimensions=1536, distance_type=VectorDistanceType.COSINE))
...
class VectorEntity256:
    ...
    content = String(id=3, uid=8662363688997292720, index=Index(type=IndexType.VALUE, uid=9111919132284886667))
    embedding = Float32Vector(id=4, uid=4216566114920401960, index=HnswIndex(dimensions=256, distance_type=VectorDistanceType.COSINE))
...
class VectorEntity384:
    ...
    content = String(id=3, uid=7177388378640589383, index=Index(type=IndexType.VALUE, uid=5351510252118108820))
    embedding = Float32Vector(id=4, uid=7475465692145108710, index=HnswIndex(dimensions=384, distance_type=VectorDistanceType.COSINE))
...
class VectorEntity512:
    ...
    content = String(id=3, uid=3705505580070095385, index=Index(type=IndexType.VALUE, uid=2382896421061802420))
    embedding = Float32Vector(id=4, uid=8704612602687791410, index=HnswIndex(dimensions=512, distance_type=VectorDistanceType.COSINE))
...
class VectorEntity64:
    ...
    content = String(id=3, uid=3234213945405272885, index=Index(type=IndexType.VALUE, uid=7169805229422572048))
    embedding = Float32Vector(id=4, uid=1702504652196090376, index=HnswIndex(dimensions=64, distance_type=VectorDistanceType.COSINE))
...
class VectorEntity768:
    ...
    embedding = Float32Vector(id=4, uid=7215409883456044223, index=HnswIndex(dimensions=768, distance_type=VectorDistanceType.COSINE))
