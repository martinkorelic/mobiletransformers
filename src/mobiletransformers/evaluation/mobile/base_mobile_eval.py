...
from mobiletransformers.evaluation.mobile_evaluator import MobileEvaluator

MINI_PERSONAL_QA_EXAMPLES = [
    {
        "type": "train",
        "category": "App Usage",
        "question": "What specific method is used by news apps to send me updates?",
        "choices": {
    ...
    },
    {
        ...
        "question": "The text thread with my old college buddies is always buzzing with new messages. Which of my social circles has a particularly lively group chat?",
        "choices": {
            "A": "My coworkers",
            "B": "My college friends",
            "C": "My high school acquaintances",
            "D": "My family",
        },
        "correct_answer": "B",
    },
    {
        ...
        "question": "What type of route do I use for my daily commute to my job?",
        "choices": {
            "A": "A scenic bike path",
            "B": "A local side street",
            "C": "The highway",
            "D": "A pedestrian walkway",
        },
        "correct_answer": "C",
    },
]
...
MINI_RECOMMENDATION_EXAMPLES = [
    {
        ...
        "prompt": "I feel really tired this evening",
        "recommendation": "Recommend early sleep, lower lighting",
    },
]
...
def evaluate_base_mini_personalqa():
    ...
    results = evaluator.evaluate(
        EVAL_DATASET,
        verbose=True,
        few_shot_examples=MINI_PERSONAL_QA_EXAMPLES,
        save_results_dir=".",
        save_outputs=True,
    )
