...
from mobiletransformers.evaluation.eval_adapter_onnx_model import CustomPeftONNXModel
...
def evaluate_finetuned():
    ...
    ADAPTER_DIR = (
        "experiment_results/TinyLlama_v1.1-mars-minipersonalqa/Qwen2-0.5B-mars-mini_personalqa-r8-a2"
    )
    ADAPTER_NAME = "mars"
...
def evaluate_onnx_mini_personalqa():
    ...
    results = evaluator.evaluate(
        EVAL_DATASET, verbose=True, save_results_dir=BASE_MODEL_DIR, save_outputs=True
    )
