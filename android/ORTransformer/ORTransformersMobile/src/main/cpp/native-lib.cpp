...
#define LOG_TAG "ORTTransformerMobile"

extern "C" JNIEXPORT jstring JNICALL
Java_com_martinkorelic_ortmobile_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
 ...
 * @return Loss value
 */
Java_com_martinkorelic_ortmobile_ORTTrainerNative_performTraining(
 ...
 */
Java_com_martinkorelic_ortmobile_ORTTrainerNative_createTrainingSession(JNIEnv *env, jobject thiz,
 ...
 * @return
 */
Java_com_martinkorelic_ortmobile_ORTGeneratorNative_createInferenceSession(
        JNIEnv *env, jobject /* this */,
 ...
 * @param session
 */
Java_com_martinkorelic_ortmobile_ORTGeneratorNative_releaseInferenceSession(
        JNIEnv *env, jobject /* this */,
        jlong session) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_martinkorelic_ortmobile_ORTTrainerNative_releaseTrainingSession(
        JNIEnv *env, jobject,
 ...
 * */
Java_com_martinkorelic_ortmobile_ORTTrainerNative_inspectWeights(JNIEnv *env, jobject thiz,
 ...
 * @return
 */
Java_com_martinkorelic_ortmobile_ORTTrainerNative_exportModelForInference(JNIEnv *env, jobject thiz,
                                                                   jlong session) {
    auto *session_cache = reinterpret_cast<TrainingSessionCache *>(session);
 ...
 */
Java_com_martinkorelic_ortmobile_ORTGeneratorNative_performInferenceStep(JNIEnv *env, jobject thiz,
                                                                  jlong session,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_martinkorelic_ortmobile_ORTTokenizerNative_createTokenizerSession(JNIEnv *env,
                                                                          jobject thiz,
...
Java_com_martinkorelic_ortmobile_ORTTokenizerNative_tokenizeString(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_martinkorelic_ortmobile_ORTTokenizerNative_decodeString(JNIEnv *env, jobject thiz,
                                                                  jlong tokenizer_model,
                                                                  jintArray sequence) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_martinkorelic_ortmobile_ORTTokenizerNative_releaseTokenizerSession(JNIEnv *env, jobject thiz, jlong tokenizer_model) {
    ReleaseTokenizerSession(tokenizer_model);
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_martinkorelic_ortmobile_ORTTokenizerNative_decodeToken(JNIEnv *env, jobject thiz,
                                                               jlong tokenizer_model,
                                                               jint token_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_martinkorelic_ortmobile_ORTTrainerNative_optimizerStep(JNIEnv *env, jobject thiz,
                                                                jlong session) {
    auto* session_cache = reinterpret_cast<TrainingSessionCache *>(session);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_martinkorelic_ortmobile_ORTTrainerNative_setLearningRate(JNIEnv *env, jobject thiz,
                                                                  jlong session,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_martinkorelic_ortmobile_ORTTrainerNative_saveModel(JNIEnv *env, jobject thiz,
 ...
 * @param session
 */
Java_com_martinkorelic_ortmobile_ORTTrainerNative_mergeExportWeights(JNIEnv *env, jobject thiz,
                                                                     jlong session,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_martinkorelic_ortmobile_ORTGeneratorNative_setSamplingConfig(JNIEnv *env, jobject thiz,
                                                                      jlong session,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_martinkorelic_ortmobile_ORTRetriever_createEmbeddingSession(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_martinkorelic_ortmobile_ORTRetriever_releaseEmbeddingSession(JNIEnv *env, jobject thiz, jlong session) {
    try {
 ...
 * @return Next token id
 */
Java_com_martinkorelic_ortmobile_ORTRetriever_performEmbeddingStep(JNIEnv *env, jobject thiz,
        jlong session,
        jlongArray input_ids,
        jlongArray attention_mask,
