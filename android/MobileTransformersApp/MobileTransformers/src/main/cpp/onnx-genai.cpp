//
// Deprecated ONNX GenAI functions, due to incompatibility with MobileTransformers functionalities
//
...
//Java_com_martinkorelic_mobiletransformers_ORTGenAINative_releaseWeightSession(
//        JNIEnv *env, jobject,
...
// * @return
// */
//Java_com_martinkorelic_mobiletransformers_ORTGenAINative_cacheSessionWeights(
...
//extern "C" JNIEXPORT void JNICALL
//Java_com_martinkorelic_mobiletransformers_ORTGenAINative_releaseGenAISession(
//        JNIEnv *env, jobject,
//jlong genai_session) {
...
// * @return
// */
//Java_com_martinkorelic_mobiletransformers_ORTGenAINative_createGenAISession(
//        JNIEnv *env, jobject /* this */,
//        jlong weight_cache,
//        jstring genai_path
//) {
...
// */
//Java_com_martinkorelic_mobiletransformers_ORTGenAINative_initializeGenAIInference(JNIEnv *env, jobject thiz,
...
// */
//Java_com_martinkorelic_mobiletransformers_ORTGenAINative_performGenAIInferenceStep(JNIEnv *env, jobject thiz,
//jlong genai_session) {
//auto *session_cache = reinterpret_cast<GenAISessionCache *>(genai_session);
//
