...
OGA_EXPORT OgaResult* OGA_API_CALL OgaCreateModelWithInitializers(const char* config_path, OgaModel** out, const std::unordered_map<std::string, OrtValue>& initializers);
